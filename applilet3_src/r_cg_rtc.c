...
void R_RTC_Create(void)
{
    ...
    RTCC0 = _20_RTC_RTC1HZ_ENABLE | _08_RTC_24HOUR_SYSTEM | _00_RTC_INTRTC_NOT_GENERATE;
    /* Set RTC1HZ pin */
    P3 &= 0xFEU;
    PM3 &= 0xFEU;
}
...
/***********************************************************************************************************************
* Function Name: R_RTC_Set_RTC1HZOn
* Description  : This function enable RTC1HZ output.
* Arguments    : None
* Return Value : None
***********************************************************************************************************************/
...
/***********************************************************************************************************************
* Function Name: R_RTC_Set_RTC1HZOff
* Description  : This function disable RTC1HZ output.
* Arguments    : None
* Return Value : None
***********************************************************************************************************************/
